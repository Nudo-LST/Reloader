...
liko.innerHTML = '<div><div style="display: flex; gap: 10px;flex-direction: row;"><span class="material-symbols-outlined" style="cursor: pointer;">content_copy</span><label style="flex-flow: 1;">Username:</label><div style="flex-grow: 1;width: 140px;">dludlun</div></div><div style="display: flex;gap: 10px;flex-direction: row;"><span class="material-symbols-outlined" style="cursor: pointer;">content_copy</span><label style="flex-grow: 1;">Password:</label><div style="flex-grow: 1;width: 140px;">C@retaker@769617</div></div></div>';
